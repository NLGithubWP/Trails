...
sql_command="SELECT run_inference_profiling(1, 'avazu', '{}', '/project/Trails/internal/ml/model_selection/config.ini', '/project/Trails/internal/ml/model_slicing/data/avazu_padding.json', '/project/tensor_log/avazu/dnn_K16', '', 10000);"
